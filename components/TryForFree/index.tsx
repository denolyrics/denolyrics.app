...
function TryForFree() {
  return (
    <div className="border-t border-slate-300 mt-10 md:mt-10 pt-10 md:pt-20">
      ...
      <div className="text-3xl md:text-4xl font-extrabold text-center mb-4 mt-10">
        <h1 id="title">Try DenoLyrics today</h1>
      </div>
      <p className="text-base font-normal text-center">Get started for free.</p>
      ...
      <div className="flex justify-center items-center mt-2">
        <Link
          ...
          className="select-none text-white hover:shadow-md bg-[#363141] hover:bg-black focus:outline-none font-medium rounded-lg inline-flex items-center px-5 py-2.5 mb-2 mt-2 border border-transparent"
          rel="noreferrer"
        >
