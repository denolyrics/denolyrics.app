...
function TryForFree() {
  return (
    ...
    <br /><br />
      ...
      <br />
      <br />
      <div className="h-[60vh] bg-gradient-try-free">
        <div className="text-3xl md:text-6xl font-extrabold text-center mb-5 p-2 max-w-screen-md m-auto bg-clip-text text-transparent bg-gradient-to-r from-white to-[#6b637b]">
