export default function Head() {
  ...
  const DOMAIN =
    process.env.NODE_ENV === "production"
      ? "https://www.denolyrics.com/integration-with-notion"
      : "http://localhost:3000";
  ...
  return (
    <>
      ...
      <meta property="og:title" content="Notion integration" />
      ...
      <meta name="twitter:title" content="Notion integration" />
      ...
      <meta
        name="keywords"
        content="web application, Audio to Text with AI, Integration with Notion, Notion pages"
      />
