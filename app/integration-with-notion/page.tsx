...
function Notion() {
  return (
    <div>
      ...
      <div className="flex justify-center items-center md:gap-60 gap-10">
        <div className="card">
          <svg
            viewBox="0 0 182 194"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="md:w-[182px] md:h-[194px] w-24 h-24"
          >
            <g id="denolyrics">
      ...
      <div className="text-3xl md:text-6xl font-extrabold text-center mb-5 mt-5">
        <h1 id="title">
          Save text output to a{" "}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#74F9BE] to-[#363141]">
            Notion
          </span>{" "}
          page
        </h1>
      ...
      <div className="max-w-screen-md md:m-auto m-3">
        <p id="description" className="text-lg font-normal text-center">
          Have you ever wished you could easily save the text of an audio so you
          can review it later? Well, now {`it's`} possible thanks to Notion!.
        </p>
      </div>
      ...
      <div className="h-auto m-3">
        <div className="grid grid-cols-1 md:grid-cols-2 m-3">
          <div className="mt-40">
            <h2 className="text-2xl md:text-5xl font-extrabold mt-7 text-center md:text-left">
              Save your notes in a{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#74F9BE] to-[#363141]">
                one second
              </span>
            </h2>
            ...
            <div className="flex justify-center items-center animation-float">
              <button
                type="submit"
                className="select-none drop-shadow-md text-2xl bg-white focus:outline-none font-medium rounded-lg inline-flex items-center px-5 py-2.5 mb-2 mt-2 border border-transparent"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
